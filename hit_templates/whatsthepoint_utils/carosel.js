var VG = (function(vg) {
   ...
   *                If true, when the buttons are clicked an additional callback
   *                function is passed to show_callback. The show_callback can
   *                call this callback when it is done rendering to scroll the
   *                page back to the position that it was in prior to clicking
   *                any buttons. This is useful if rendering modifies the page
   *                length and is not instanteanous (such as if images are
   *                loaded).
   *
